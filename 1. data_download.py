...
# To download different types of file modify "if year in li.text and 'sample/historical' in li.text:" in getFilesFromFreddieMac
...
def getFilesFromFreddieMac(payload, startY, endY):
    ...
    for year in year_list:
        for li in ziplist:
            if year in li.text and 'sample' in li.text:
...
def main():
    ...
    user = 'freddie_mac_registered_email_id'
    password = 'password'
